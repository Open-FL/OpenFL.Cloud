...
namespace OpenFL.Cloud.Endpoints.Run
{
    public class FLRunEndpointWorkItem : EndpointWorkItem
    {
        ...
        public string Width => Request.QueryString.AllKeys.Contains("width") && !string.IsNullOrEmpty(Request.QueryString.Get("width")) ? Request.QueryString.Get("width") : "128";
        public string Height => Request.QueryString.AllKeys.Contains("height") && !string.IsNullOrEmpty(Request.QueryString.Get("height")) ? Request.QueryString.Get("height") : "128";
